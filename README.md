...
CSVの比較対象は各フィールドの文字列です。文字コードと区切り文字は比較オプションで指定します。
...
- `CSVファイルの文字コードを自動判定できません。`: CSV文字コードを手動で指定してください。
- `CSVファイルを ... として読み取れません。`: CSV文字コードの指定を確認してください。Shift_JISのCSVは `Shift_JIS` を選択してください。
- `CSV区切り文字は1文字で指定してください。`: CSV区切り文字にはカンマ、タブ、セミコロンなど1文字を指定してください。
